        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="item" items="${listItem}">
                <tr>
                    ...
                    <td><c:out value="${item.mdate}" /></td>
                    <td><c:out value="${item.edate}" /></td>
                    <td><c:out value="${item.category}" /></td>
                    <td>
                    	<button class="btn btn-success"><a style="color:gray;" href="item?action=edit&id=<c:out value='${item.id}' />">Edit</a></button>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<button class="btn btn-danger"><a style="color:gray;" href="item?action=delete&id=<c:out value='${item.id}' />" onclick="return confirm('Do you want to delete?')">Delete</a></button>                   	
                    </td>
                </tr>
            </c:forEach>
        </table>

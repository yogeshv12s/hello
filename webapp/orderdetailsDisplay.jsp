...
<body style="background: aquamarine;">
	...
	<center>
		...
		<div class="container">
			<a href="orderdetails?action=new" class="btn btn-info">Add New OrderDetails</a>
		</div>       	
        </h4>
        <hr>
	</center>
        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="orderdetails" items="${listOrderDetails}">
                <tr>
                    ...
                    <td><c:out value="${orderdetails.customer}" /></td>
                    <td><c:out value="${orderdetails.paymentmode}" /></td>
                    <td><c:out value="${orderdetails.dateofpurchase}" /></td>
                    <td><c:out value="${orderdetails.shop}" /></td>
                    <td><c:out value="${orderdetails.total}" /></td>
                    <td>
                    	<button class="btn btn-success"><a style="color:gray;" href="orderdetails?action=edit&id=<c:out value='${orderdetails.id}' />">Edit</a></button>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<button class="btn btn-danger"><a style="color:gray;" href="orderdetails?action=delete&id=<c:out value='${orderdetails.id}' />" onclick="return confirm('Do you want to delete?')">Delete</a></button>                            	
                    </td>
                </tr>
            </c:forEach>
        </table>

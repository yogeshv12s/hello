        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="owner" items="${listOwner}">
                <tr>
                    ...
                    <td><c:out value="${owner.adress}" /></td>
                    <td><c:out value="${owner.dob}" /></td>
                    <td><c:out value="${owner.shopname}" /></td>
                    <td>
                    	<button class="btn btn-success"><a style="color:gray;" href="owner?action=edit&id=<c:out value='${owner.id}' />">Edit</a></button>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<button class="btn btn-danger"><a style="color:gray;" href="owner?action=delete&id=<c:out value='${owner.id}' />" onclick="return confirm('Do you want to delete?')">Delete</a></button>                   	
                    </td>
                </tr>
            </c:forEach>
        </table>
